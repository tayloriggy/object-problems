...
5. Create a function that takes in an array of objects as its parameter.
6. Iterate through the elements of the array of objects.
7. Return the values of all first and last names.
